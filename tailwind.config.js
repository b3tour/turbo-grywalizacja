  ...
  theme: {
    extend: {
      colors: {
        ...
        // Kolory drużyn
        team: {
          red: '#EF4444',      // Turbo Racers
          blue: '#3B82F6',     // Speed Demons
          green: '#10B981',    // Power Squad
          orange: '#F59E0B',   // Nitro Force
          purple: '#A855F7',   // Thunder Team
        }
      },
      animation: {
        ...
        'team-pulse': 'team-pulse 2s ease-in-out infinite',
